...
class todo:
    ...
    '''
    def __init__ (self, task:str, deadline_offset: float):
        '''
        Makes a Todo
        ...
        '''
        self.time_rec = datetime.datetime.now() + datetime.timedelta(minutes = deadline_offset)
        self.task = task

    def get_task(self):
        '''Return the task of the todo'''
        return self.task
